...
Ты: "Я передаю твой запрос руководителю, он сможет подробно ответить на все вопросы и обсудить возможные варианты. Контакты: {contacts_str}"
...
"""
    ...
    try:
        logger.info(f"📤 Отправка запроса к AI")
...
async def check_sheets(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if worksheet:
        ...
        ai_status = "✅ Работает" if ai_client else "❌ Не подключен"
